...
int main(int argc, char** argv) {
    ...
    do {
        ...
        switch (cmd) {
          ...
          case '+':
            table.insert(item);
            cout << "Inserted data item with key (" << item.getKey() << ") and value (" << item.getValue() << ")" << endl;
            break;
          ...
          case '-':
            ...
            if (table.remove(item.getKey())) {
                ...
                cout << "Removed data item with key (" << item.getKey() << ")" << endl;
            }
                ...
                cout << "Could not remove data item with key (" << item.getKey() << ")" << endl;
          ...
          case '?':
            ...
            if (table.retrieve(item.getKey(), item)) {
                ...
                cout << "Retrieved data item with key (" << item.getKey() << ") and value (" << item.getValue() << ")" << endl;

            }
            else {

                cout << "Could not retrieve data item with key (" << item.getKey() << ")" << endl;
